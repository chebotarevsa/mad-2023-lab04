...
class CardAdd : AppCompatActivity() {
    lateinit var binding: ActivityCardAddBinding //Будет инициализированно позже - lateinit
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCardAddBinding.inflate(layoutInflater) //Надувание из хмл в вью
