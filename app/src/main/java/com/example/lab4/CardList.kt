...
class CardList : AppCompatActivity() {
    lateinit var binding: ActivityCardListBinding  //Будет инициализированно позже - lateinit
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCardListBinding.inflate(layoutInflater) //Всё по стандарту: раздуваем хмл во вью
