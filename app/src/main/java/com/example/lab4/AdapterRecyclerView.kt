...
class AdapterRecyclerView(private var cards: List<Card>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder { //Вызывается при создании нового элемента списка - карточки
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.activity_card, parent, false) //Создание элемента списка
